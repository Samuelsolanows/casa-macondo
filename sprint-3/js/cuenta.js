...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (currentUser.id_rol === 1) {
    ...
    // Activar pestaña por defecto para Admin: Administrar Alojamientos
    activateTab('accommodations');
  } else {
    // Activar pestaña por defecto para Usuario regular: Mis Emprendimientos
    activateTab('ventures');
  }
